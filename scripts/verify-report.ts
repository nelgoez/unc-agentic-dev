...
| Aspecto | Resultado |
|---------|-----------|
| Restricción a nivel de sección | ${module3Assessment ? (module3Assessment).hasSectionRestriction : 'N/A'} |
| Actividades totales en Módulo 3 | ${module3Assessment ? (module3Assessment).totalActivities : 'N/A'} |
| Actividades con restricciones individuales | ${module3Assessment ? (Array.isArray((module3Assessment).restrictedActivities) ? ((module3Assessment).restrictedActivities as Array<unknown>).length : 'N/A') : 'N/A'} |
